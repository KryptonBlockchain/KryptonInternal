...
protected:
    void onWSConnecting(LinkKing::HTTP::HTTPRequest& request) override
    {
    ...
    void onWSConnected(const LinkKing::HTTP::HTTPResponse& response) override { connected = true; }
...
protected:
    void onWSConnected(const LinkKing::HTTP::HTTPRequest& request) override { connected = true; }
    void onWSDisconnected() override { disconnected = true; }
...
TEST_CASE("WebSocket secure server test", "[LinkKing][WebSocket]")
{
...
TEST_CASE("WebSocket secure server multicast test", "[LinkKing][WebSocket]")
{
    const std::string address = "127.0.0.1";
    const int port = 8445;
...
TEST_CASE("WebSocket secure server random test", "[LinkKing][WebSocket]")
{
    const std::string address = "127.0.0.1";
    const int port = 8446;
