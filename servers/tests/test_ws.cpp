...
TEST_CASE("WebSocket server test", "[LinkKing][WebSocket]")
{
...
TEST_CASE("WebSocket server multicast test", "[LinkKing][WebSocket]")
{
    const std::string address = "127.0.0.1";
    const int port = 8082;
...
TEST_CASE("WebSocket server random test", "[LinkKing][WebSocket]")
{
    const std::string address = "127.0.0.1";
    const int port = 8083;
